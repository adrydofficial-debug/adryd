...
export const CHAT_API_URL = 'https://adryd-backend-production.up.railway.app';
export const CHAT_API_URL_FALLBACK = 'https://adryd-backend.onrender.com';
